...
public class ProfileService : IProfileService
{
    ...
    public async Task<bool> DepositPoints(ulong discordId, double points, CancellationToken token)
    {
        var profile = await _provider.GetByDiscordId(discordId, token);
    ...
    public async Task<bool> WithdrawPoints(ulong discordId, double points, CancellationToken token)
    {
        var profile = await _provider.GetByDiscordId(discordId, token);
